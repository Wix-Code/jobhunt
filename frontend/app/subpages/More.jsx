...
const More = () => {
  return (
    <div className='bg-[#151719] mt-4'>
      <div className='flex flex-col items-center max-w-[1100px] m-auto max-sm:gap-3'>
        <div className='flex overflow-hidden max-sm:flex-col max-sm:mx-7 max-sm:gap-3'>
          <div className='flex-1'>
            <img className='w-full object-cover h-[400px] max-sm:h-[250px]' src="https://omenmahotels.com/wp-content/uploads/2024/03/3pexels-keeshas-kitchen-13915043-780x520.jpg.webp" alt="" />
          </div>
        ...
        <div className='flex overflow-hidde max-sm:flex-col max-sm:mx-7 max-sm:gap-3'>
          <div className='bg-[#000] flex-1'>
          ...
          <div className='flex-1'><img className='w-full max-sm:h-[250px] object-cover h-[400px]' src="https://omenmahotels.com/wp-content/uploads/2024/03/3pexels-keeshas-kitchen-13915043-780x520.jpg.webp" alt="" /></div>
        </div>
      </div>
    </div>
  )
