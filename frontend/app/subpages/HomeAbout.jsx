...
const HomeAbout = () => {
  ...
  return (
    <div className='bg-[#151719] mt-5'>
      <div className='flex items-center flex-row max-w-[1100px] m-auto max-sm:flex-col max-sm:mx-7 max-sm:gap-4 overflow-hidden'>
        <div className='flex-1 flex-col flex gap-4' data-aos="fade-right">
        ...
        <div className='flex-1 max-sm:w-full' data-aos="fade-left">
