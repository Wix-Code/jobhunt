...
const HomeAbout = () => {
  return (
    <div className='bg-[#151719]'>
      <div className='flex items-center flex-row max-w-[1100px] m-auto max-sm:flex-col max-sm:mx-5'>
        <div className='flex-1 flex-col flex gap-4'>
          <p className='text-[#b99d75] uppercase text-[14px] font-[600]'>Stay in the heart of Senerity</p>
          <h1 className='text-[#FFFFFF] text-[44px] font-semibold'>Luxury furnished serviced rooms in Mbaise, Imo State</h1>
        ...
        <div className='flex-1 px-5'>
          <img className='h-[500px] w-full object-cover' src="https://omenmahotels.com/wp-content/uploads/2024/03/Omenma-C-1-scaled-e1711200148404-600x687.jpg.webp" alt="" />
        </div>
      </div>
    </div>
  )
