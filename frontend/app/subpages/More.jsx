  ...
  return (
    <div className='bg-[#151719] mt-4'>
      <div className='flex flex-col items-center max-w-[1100px] m-auto max-sm:gap-3'>
        <div className='flex overflow-hidden max-sm:flex-col max-sm:mx-10 max-sm:gap-3'>
          ...
          <div className='bg-[#000] flex-1'>
            <div className='flex flex-col justify-between m-20 gap-4  max-sm:m-5 max-sm:gap-2'>
        ...
        <div className='flex overflow-hidde max-sm:flex-col max-sm:mx-10 max-sm:gap-3'>
          <div className='bg-[#000] flex-1'>
